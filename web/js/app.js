...
const TRANSLATIONS = {
  ru: {
    ...
    // Modern Modals Keys
    "calendar.settings_subtitle": "Настройка отображения расписания, событий и источников метаданных",
    "calendar.poll_title": "Синхронизация дат",
    "poster_opt.subtitle": "Настройка масштаба, информационных бейджей и прогресса",
    "cf.modal_subtitle": "Настройка правил сопоставления и приоритетов релизов",
    "totp.modal_subtitle": "Защита аккаунта временными кодами аутентификации",
    "blocklist.add_title": "Заблокировать релиз вручную",
    "blocklist.add_subtitle": "Исключение раздачи из автоматического поиска и граббинга",
    "blocklist.edit_title": "Редактировать заблокированный релиз",
    "blocklist.edit_subtitle": "Изменение параметров и причины блокировки",
    "blocklist.show_label": "Тайтл (сериал / фильм):",
    "blocklist.show_hint": "Если выбрать сериал/фильм, релиз будет блокироваться только для него.",
    "blocklist.show_edit_hint": "Если выбрать сериал/фильм, релиз будет исключаться только при его поиске.",
    "blocklist.release_title_or_hash": "Название релиза или инфохэш",
    "blocklist.release_title": "Название релиза",
    "blocklist.hash_optional": "Инфохэш торрента (опционально):",
    "blocklist.url_optional": "Ссылка на раздачу (страница трекера, опционально):",
    "blocklist.reason": "Причина блокировки:",
    "blocklist.quick_choice": "Быстрый выбор:",
    "blocklist.btn_block": "Заблокировать",
    "blocklist.btn_manual_block": "Заблокировать релиз",
    "blocklist.btn_clear_all": "Очистить всё",
    "blocklist.stat_releases": "Раздач в списке",
    "blocklist.stat_titles": "Тайтлов",
    "blocklist.search_placeholder": "Поиск по названию раздачи, хэшу или причине...",
    "blocklist.view_cards": "Вид: Карточки",
    "blocklist.view_table": "Вид: Таблица",
    "blocklist.cards_view": "Карточки",
    "blocklist.table_view": "Таблица",
    "blocklist.titles_sidebar": "Тайтлы",
    "blocklist.filter_titles_placeholder": "Фильтр тайтлов...",
    "blocklist.select_all": "Выбрать все",
    "blocklist.clear_for_title": "Очистить для тайтла",
    "blocklist.empty_title": "Черный список пуст",
    "blocklist.empty_desc": "Ни одна раздача не заблокирована. Система автоматически занесет сюда раздачи, если в них не окажется нужных файлов.",
    "blocklist.col_release": "Раздача / Тайтл",
    "blocklist.col_indexer": "Трекер",
    "blocklist.col_quality": "Качество",
    "blocklist.col_reason": "Причина блокировки",
    "blocklist.col_actions": "Действие",
    "blocklist.selected": "Выбрано",
    "blocklist.batch_unblock": "Разблокировать выбранные",
    "blocklist.clear_selection": "Снять выбор",
    "blocklist.filter_all": "Все",
    "blocklist.filter_no_seeds": "Нет сидов",
    "blocklist.filter_error": "Ошибка / Отклонено",
    "blocklist.filter_audio": "Озвучка / Язык",
    "blocklist.filter_manual": "Вручную",
    "blocklist.filter_quality": "Качество / CF",
    "blocklist.btn_unblock": "Разблокировать",
    "blocklist.btn_edit": "Изменить",
    "blocklist.btn_tracker": "Трекер",
    "blocklist.copy_hash": "Скопировать инфохэш",
    "blocklist.hash_copied": "Инфохэш скопирован",
    "blocklist.unblocked_success": "Раздача разблокирована",
    "blocklist.batch_unblocked_success": "Выбранные раздачи разблокированы",
    "blocklist.posters_on": "Обложки: Вкл",
    "blocklist.posters_off": "Обложки: Выкл",
    ...
    "indexers.subtitle": "Подключение Torznab, Newznab, Torrent RSS и трекеров",
    "indexers.type": "Тип",
    "indexers.url": "URL индексатора",
    "indexers.key": "API ключ / Passkey",
    "indexers.priority": "Приоритет",
    "indexers.check_settings_subtitle": "Периодический мониторинг доступности индексаторов и трекеров",
    "dc.subtitle": "Интеграция с qBittorrent, Transmission, Deluge, rTorrent, Aria2, Usenet",
    "dc.type": "Тип клиента",
    "dc.host": "Хост / IP",
    "dc.category": "Категория / Label",
    "qp.subtitle": "Укажите список допустимых качеств и пороговые значения",
    "md.subtitle": "Поставщики информации о фильмах, сериалах, аниме, постерах и датах релизов",
    "md.type": "Провайдер",
    "nt.subtitle": "Настройка оповещений в Telegram, Discord, Ntfy, Webhook и другие каналы",
    "nt.type": "Тип провайдера",
    ...
    "collections_poster_opt.size": "Размер карточек саг в сетке",
    "collections_poster_opt.progress_text": "Индикатор прогресса фильмов",
    "collections_poster_opt.progress_text_hint": "Показывать количество скачанных фильмов (например, 2 / 3) и процент",
    "collections_poster_opt.show_title": "Показать название франшизы",
    "collections_poster_opt.show_title_hint": "Отображать название саги",
    "collections_poster_opt.show_monitored": "Показать статус отслеживания",
    "collections_poster_opt.show_monitored_hint": "Показывать статус мониторинга саги",
    "collections_poster_opt.show_parts": "Показать бейдж количества частей",
    "collections_poster_opt.show_parts_hint": "Отображать бейдж общего числа фильмов саги",
    ...
    "activity.btn_check_completed": "Проверить загрузки",
    ...
    "history.download_show": "Скачать .txt тайтла",
    "history.clear_show": "Очистить логи тайтла",
    "history.clear_show_confirm": "Очистить историю релизов для тайтла",
    "history.lifecycle_runs": "История жизненных циклов (запусков)",
    "history.search_placeholder": "Поиск по названию или трекеру…",
    ...
    "journal.retention_subtitle": "Настройка срока автоматической очистки устаревших записей журнала",
    "journal.retention_label": "Хранить записи журнала и событий",
    "journal.empty": "Записей нет",
    "journal.search_placeholder": "Поиск по логам…",
    ...
    "backup.stat_total_size": "Общий объём:",
    "backup.stat_latest": "Последний бэкап",
    "backup.stat_schedule": "Авто-бэкап",
    "backup.stat_retention_label": "Ротация:",
    ...
    "show.ova_mode_season_1": "OVA = Сезон 1",
    ...
    "settings.btn_fix_permissions_title": "Рекурсивно применить права доступа (chmod 0777/0666) ко всем папкам медиатеки для Jellyfin / Plex",
    ...
    "settings.ssl_notice_title": "Важно для браузера:",
    ...
    "library.bulk_select_all": "Выбрать все",
    ...
    "library.bulk_unmonitor": "Снять",
    "library.bulk_delete": "Удалить",
    "library.bulk_done": "Готово",

    // Interactive Search
    "search.title_prefix": "Поиск:",
    "search.query_placeholder": "Введите название фильма, сериала или аниме для расширенного поиска...",
    "search.reset_tooltip": "Сбросить на оригинал",
    "search.filter_label": "Фильтр:",
    "search.all_indexers": "Все индексаторы",
    "search.all_releases": "Все релизы",
    "search.approved_only": "Только одобренные",
    "search.rejected_only": "Отклонённые",
    "search.results_found": "Найдено:",
    "search.col_age": "Возраст",
    "search.col_release": "Релиз / Раздача",
    "search.col_indexer": "Индексатор",
    "search.col_size": "Размер",
    "search.col_seeders": "Сиды",
    "search.col_quality": "Качество",
    "search.col_languages_group": "Языки / Группа",
    "search.col_formats_score": "Форматы / Счёт",
    "search.col_action": "Действие",
    "search.approved_tooltip_title": "Релиз одобрен",
    "search.approved_tooltip_text": "Релиз соответствует критериям DecisionEngine и готов к загрузке.",
    "search.rejected_tooltip_title": "Релиз отклонён:",
    "search.rejected_fallback": "Релиз не соответствует критериям профиля",
    "search.btn_grab": "Захватить",
    "search.btn_force_grab": "Force Grab",
    "search.match_label": "Матч:",
    "search.no_results_hint": "Попробуйте ввести другое название в поисковой строке выше",

    // Calendar Detail Modal
    "calendar.detail_premiere": "Дата премьеры",
    "calendar.detail_air_date": "Дата выхода серии",
    "calendar.detail_monitoring": "Отслеживание:",
    "calendar.status_enabled": "Включено",
    // Release Logs & Diagnostics
    "release_logs.stage_decision": "Решение",
    "release_logs.winner": "Победитель",
    "release_logs.rank": "Ранг",
    "release_logs.quality_rank": "Качество",
    "release_logs.seeds": "Сиды",
    "release_logs.cover": "Охват",
    "release_logs.reason": "Обоснование",
    "release_logs.file_name": "Имя файла",
    "release_logs.decision_reason": "Причина отбора / отключения",
    "release_logs.rejection_reason": "Причина отклонения",
    "release_logs.candidates_by_indexer": "Найдено кандидатов по индексаторам:",
    "release_logs.decision_ranking_title": "Сравнение кандидатов и выбор релиза (Decision Ranking)",
    "release_logs.file_decisions_title": "Решения по файлам раздачи (приоритеты серий)",
    "release_logs.rejected_sample_title": "Примеры отклонённых кандидатов",
    "release_logs.timestamp": "Время записи:",
    "release_logs.stage": "Этап обработки:",
    "release_logs.level": "Статус / Уровень:",
    "release_logs.show_title": "Тайтл (Медиа):",
    "release_logs.indexer": "Индексатор / Трекер:",
    "release_logs.source_link": "Ссылка на раздачу / сайт:",
    "release_logs.release_title": "Оригинальное название раздачи:",
    "release_logs.engine_message": "Сообщение движка:",
    "release_logs.show_json": "Показать полный технический контекст (JSON)",
    "release_logs.no_clients": "Нет активных настроенных загрузчиков (Transmission / qBittorrent)",
    "release_logs.client_error": "Ошибка подключения к клиенту:",
    "release_logs.client_online": "В сети",
    "release_logs.torrents_active": "активных",
    "release_logs.daemon_logs_empty": "Демон-логи пустые или RPC-журнал не включен в демоне загрузчика",
    "release_logs.torrents_list": "Список текущих торрентов в клиенте",

    // Dataset Harvester
    "harvester.stat_total": "Собрано записей",
    "harvester.stat_accuracy": "Точность парсера",
    "harvester.stat_approved": "Одобрено движком",
    "harvester.stat_rejected": "Отклонено движком",
    "harvester.stat_non_video": "Не-видео контент",
    "harvester.stat_unknown": "Не распознано",
    "harvester.stat_video_suffix": "видео",
    "harvester.stat_parsed_suffix": "распознано",
    "harvester.stat_wanted_overlap_suffix": "с разыскиваемыми",
    "harvester.stat_rejected_hint": "не подошли параметры",
    "harvester.stat_non_video_hint": "игры, OST, манга",
    "harvester.stat_unknown_hint": "краевые случаи",
    "harvester.filter_all": "Все записи",
    "harvester.filter_approved": "Одобрено DecisionEngine",
    "harvester.filter_rejected": "Отклонено DecisionEngine",
    "harvester.filter_wanted_eps": "Закрывает разыскиваемые серии",
    "harvester.filter_video": "Только видео-релизы",
    "harvester.filter_unknown": "Не распознано (Unknown)",
    "harvester.filter_multi_part": "Сплит-куры (Part 2+)",
    "harvester.filter_non_video": "Не-видео (отфильтровано)",
    "harvester.search_placeholder": "Поиск по названию или трекеру…",
    "harvester.col_query": "Запрос / Трекер",
    "harvester.col_title": "Заголовок раздачи с трекера",
    "harvester.col_size": "Размер / Качество",
    "harvester.col_episodes": "Серии (Парсер)",
    "harvester.col_match": "Сопоставление с БД",
    "harvester.col_decision": "Решение DecisionEngine",
    "harvester.col_actions": "Действия",
    "harvester.btn_start": "Запустить проверку",
    "harvester.btn_download_unknown": "Неизвестные (~30 КБ)",
    "harvester.btn_download_all": "Скачать всё (.json)",
    "harvester.btn_clear": "Очистить",
    "harvester.btn_stop": "Остановить",
    "harvester.dry_run_title": "Безопасная симуляция (Dry-Run):",
    "harvester.dry_run_text": "Раздачи только анализируются и сопоставляются с сериями из базы в памяти. Никакой контент в торрент-клиент не добавляется и не скачивается.",
    "harvester.custom_query_label": "Тайтлы для поиска (через запятую или построчно):",
    "harvester.custom_query_placeholder": "Например: Re:Zero, Клеватесс, Bleach, Судьба: Ночь схватки, Табакошка...",
    "harvester.progress_collecting": "Выполняется сбор раздач...",
  },
  en: {
    // Navigation & Tabs
    ...
    // Modern Modals Keys
    "calendar.settings_subtitle": "Configure schedule display, event views and metadata sources",
    "calendar.poll_title": "Date Synchronization",
    "poster_opt.subtitle": "Configure scale, information badges and progress display",
    "cf.modal_subtitle": "Configure matching rules and release scoring priorities",
    "totp.modal_subtitle": "Protect your account with temporary authentication codes",
    "blocklist.add_title": "Block Release Manually",
    "blocklist.add_subtitle": "Exclude release from auto-search and automated grabbing",
    "blocklist.edit_title": "Edit Blocked Release",
    "blocklist.edit_subtitle": "Modify parameters and blocking reasons",
    "blocklist.show_label": "Media Title (Series / Movie):",
    "blocklist.show_hint": "If selected, this release will only be blocked for this media item.",
    "blocklist.show_edit_hint": "If selected, this release will only be excluded when searching for this media item.",
    "blocklist.release_title_or_hash": "Release Title or Infohash",
    "blocklist.release_title": "Release Title",
    "blocklist.hash_optional": "Torrent Infohash (optional):",
    "blocklist.url_optional": "Release URL (tracker page, optional):",
    "blocklist.reason": "Block Reason:",
    "blocklist.quick_choice": "Quick choice:",
    "blocklist.btn_block": "Block Release",
    "blocklist.btn_manual_block": "Block Release",
    "blocklist.btn_clear_all": "Clear All",
    "blocklist.stat_releases": "Blocked Releases",
    "blocklist.stat_titles": "Media Titles",
    "blocklist.search_placeholder": "Search by release title, infohash, or reason...",
    "blocklist.view_cards": "View: Cards Grid",
    "blocklist.view_table": "View: Table View",
    "blocklist.cards_view": "Cards",
    "blocklist.table_view": "Table",
    "blocklist.titles_sidebar": "Media Titles",
    "blocklist.filter_titles_placeholder": "Filter titles...",
    "blocklist.select_all": "Select All",
    "blocklist.clear_for_title": "Clear for Title",
    "blocklist.empty_title": "Blocklist is empty",
    "blocklist.empty_desc": "No releases are currently blocked. The system will automatically add releases here if needed files are missing.",
    "blocklist.col_release": "Release / Media Title",
    "blocklist.col_indexer": "Tracker",
    "blocklist.col_quality": "Quality",
    "blocklist.col_reason": "Block Reason",
    "blocklist.col_actions": "Actions",
    "blocklist.selected": "Selected",
    "blocklist.batch_unblock": "Unblock Selected",
    "blocklist.clear_selection": "Clear Selection",
    "blocklist.filter_all": "All",
    "blocklist.filter_no_seeds": "No Seeds",
    "blocklist.filter_error": "Errors / Rejection",
    "blocklist.filter_audio": "Audio / Language",
    "blocklist.filter_manual": "Manual",
    "blocklist.filter_quality": "Quality / CF",
    "blocklist.btn_unblock": "Unblock",
    "blocklist.btn_edit": "Edit",
    "blocklist.btn_tracker": "Tracker",
    "blocklist.copy_hash": "Copy infohash",
    "blocklist.hash_copied": "Infohash copied",
    "blocklist.unblocked_success": "Release unblocked and removed",
    "blocklist.batch_unblocked_success": "Selected releases unblocked",
    "blocklist.posters_on": "Posters: ON",
    ...
    "indexers.subtitle": "Connect Torznab, Newznab, Torrent RSS feeds and trackers",
    "indexers.type": "Type",
    "indexers.url": "Indexer URL",
    "indexers.key": "API Key / Passkey",
    "indexers.priority": "Priority",
    "indexers.check_settings_subtitle": "Periodic availability and health checks for indexers and trackers",
    "dc.subtitle": "Integration with qBittorrent, Transmission, Deluge, rTorrent, Aria2, Usenet",
    "dc.type": "Client Type",
    "dc.host": "Host / IP",
    "dc.category": "Category / Label",
    "qp.subtitle": "Specify allowed qualities and threshold cutoff parameters",
    "md.subtitle": "Metadata providers for movies, TV series, anime, posters and release dates",
    "md.type": "Provider",
    "nt.subtitle": "Configure alerts for Telegram, Discord, Ntfy, Webhooks and other channels",
    "nt.type": "Provider Type",
    ...
    "collections_poster_opt.size": "Collection card size in grid",
    "collections_poster_opt.progress_text": "Movie progress indicator",
    "collections_poster_opt.progress_text_hint": "Show downloaded movies count (e.g. 2 / 3) and percentage",
    "collections_poster_opt.show_title": "Show collection title",
    "collections_poster_opt.show_title_hint": "Display franchise name",
    "collections_poster_opt.show_monitored": "Show monitoring status",
    "collections_poster_opt.show_monitored_hint": "Display collection monitoring pill",
    "collections_poster_opt.show_parts": "Show total parts badge",
    "collections_poster_opt.show_parts_hint": "Display total franchise movies badge",
    ...
    "activity.btn_check_completed": "Check Downloads",
    ...
    "history.download_show": "Download Title .txt",
    "history.clear_show": "Clear Title Logs",
    "history.clear_show_confirm": "Clear release history for title",
    "history.lifecycle_runs": "Lifecycle Runs & Sessions",
    "history.search_placeholder": "Search by title or tracker…",
    ...
    "journal.retention_subtitle": "Configure retention period for automated log cleanup",
    ...
    "backup.stat_total_size": "Total size:",
    "backup.stat_latest": "Latest Backup",
    "backup.stat_schedule": "Auto-Backup",
    "backup.stat_retention_label": "Rotation:",
    ...
    "show.ova_mode_season_1": "OVA = Season 1",
    ...
    "settings.btn_fix_permissions_title": "Recursively fix media directory permissions (chmod 0777/0666) for Jellyfin / Plex",
    ...
    "settings.ssl_notice_title": "Important for Browser:",
    ...
    "library.bulk_btn_title": "Select titles and edit in bulk",
    "library.bulk_select_all": "Select All",
    ...
    "library.bulk_unmonitor": "Unmonitor",
    "library.bulk_delete": "Delete",
    "library.bulk_done": "Done",

    // Interactive Search
    "search.title_prefix": "Search:",
    "search.query_placeholder": "Enter movie, series or anime title for custom search...",
    "search.reset_tooltip": "Reset to default query",
    "search.filter_label": "Filter:",
    "search.all_indexers": "All Indexers",
    "search.all_releases": "All Releases",
    "search.approved_only": "Approved Only",
    "search.rejected_only": "Rejected",
    "search.results_found": "Found:",
    "search.col_age": "Age",
    "search.col_release": "Release / Torrent",
    "search.col_indexer": "Indexer",
    "search.col_size": "Size",
    "search.col_seeders": "Seeds",
    "search.col_quality": "Quality",
    "search.col_languages_group": "Languages / Group",
    "search.col_formats_score": "Formats / Score",
    "search.col_action": "Action",
    "search.approved_tooltip_title": "Release Approved",
    "search.approved_tooltip_text": "Release matches DecisionEngine criteria and is ready for download.",
    "search.rejected_tooltip_title": "Release Rejected:",
    "search.rejected_fallback": "Release does not match quality profile criteria",
    "search.btn_grab": "Grab",
    "search.btn_force_grab": "Force Grab",
    "search.match_label": "Match:",
    "search.no_results_hint": "Try entering a different title in the search box above",

    // Calendar Detail Modal
    "calendar.detail_premiere": "Premiere Date",
    "calendar.detail_air_date": "Episode Air Date",
    "calendar.detail_monitoring": "Monitoring:",
    "calendar.status_enabled": "Enabled",
    // Release Logs & Diagnostics
    "release_logs.stage_decision": "Decision",
    "release_logs.winner": "Winner",
    "release_logs.rank": "Rank",
    "release_logs.quality_rank": "Quality",
    "release_logs.seeds": "Seeds",
    "release_logs.cover": "Cover",
    "release_logs.reason": "Reason",
    "release_logs.file_name": "File Name",
    "release_logs.decision_reason": "Decision Reason",
    "release_logs.rejection_reason": "Rejection Reason",
    "release_logs.candidates_by_indexer": "Candidates found by indexers:",
    "release_logs.decision_ranking_title": "Candidate Comparison & Decision Ranking",
    "release_logs.file_decisions_title": "Torrent File Priority Decisions",
    "release_logs.rejected_sample_title": "Rejected Candidates Sample",
    "release_logs.timestamp": "Timestamp:",
    "release_logs.stage": "Stage:",
    "release_logs.level": "Level / Status:",
    "release_logs.show_title": "Show Title:",
    "release_logs.indexer": "Indexer / Tracker:",
    "release_logs.source_link": "Tracker / Source Link:",
    "release_logs.release_title": "Original Release Title:",
    "release_logs.engine_message": "Engine Message:",
    "release_logs.show_json": "Show full technical context (JSON)",
    "release_logs.no_clients": "No active configured download clients (Transmission / qBittorrent)",
    "release_logs.client_error": "Client connection error:",
    "release_logs.client_online": "Online",
    "release_logs.torrents_active": "active",
    "release_logs.daemon_logs_empty": "Daemon log is empty or RPC logging is disabled in client daemon",
    "release_logs.torrents_list": "Current torrents list in client",

    // Dataset Harvester
    "harvester.stat_total": "Collected Records",
    "harvester.stat_accuracy": "Parser Accuracy",
    "harvester.stat_approved": "Approved by Engine",
    "harvester.stat_rejected": "Rejected by Engine",
    "harvester.stat_non_video": "Non-Video Content",
    "harvester.stat_unknown": "Unrecognized",
    "harvester.stat_video_suffix": "videos",
    "harvester.stat_parsed_suffix": "parsed",
    "harvester.stat_wanted_overlap_suffix": "wanted overlap",
    "harvester.stat_rejected_hint": "unmet criteria",
    "harvester.stat_non_video_hint": "games, OST, manga",
    "harvester.stat_unknown_hint": "edge cases",
    "harvester.filter_all": "All Records",
    "harvester.filter_approved": "Approved by DecisionEngine",
    "harvester.filter_rejected": "Rejected by DecisionEngine",
    "harvester.filter_wanted_eps": "Covers Wanted Episodes",
    "harvester.filter_video": "Video Releases Only",
    "harvester.filter_unknown": "Unrecognized (Unknown)",
    "harvester.filter_multi_part": "Split-cour (Part 2+)",
    "harvester.filter_non_video": "Non-Video (Filtered)",
    "harvester.search_placeholder": "Search by title or tracker…",
    "harvester.col_query": "Query / Tracker",
    "harvester.col_title": "Tracker Release Title",
    "harvester.col_size": "Size / Quality",
    "harvester.col_episodes": "Episodes (Parser)",
    "harvester.col_match": "Database Match",
    "harvester.col_decision": "DecisionEngine Verdict",
    "harvester.col_actions": "Actions",
    "harvester.btn_start": "Run Verification",
    "harvester.btn_download_unknown": "Unknown (~30 KB)",
    "harvester.btn_download_all": "Download All (.json)",
    "harvester.btn_clear": "Clear",
    "harvester.btn_stop": "Stop",
    "harvester.dry_run_title": "Safe Simulation (Dry-Run):",
    "harvester.dry_run_text": "Torrents are only analyzed and matched with database episodes in memory. No content is added or downloaded in the torrent client.",
    "harvester.custom_query_label": "Titles to search (comma-separated or per line):",
    "harvester.custom_query_placeholder": "For example: Re:Zero, Bleach, Fate: Stay Night, Solo Leveling...",
    "harvester.progress_collecting": "Collecting releases in progress...",
  },
};
let CURRENT_LANG = "ru";
...
function setCollectionsCardStyle(style) {
  if (!["neoglass", "cinematic", "classic"].includes(style)) return;
  ...
  if (grid) {
    grid.classList.remove("card-style-neoglass", "card-style-cinematic", "card-style-classic");
    grid.classList.add(`card-style-${CURRENT_COLLECTIONS_CARD_STYLE}`);
  }
...
try {
  const savedColl = localStorage.getItem("aliasarr_collections_poster_options");
  if (savedColl) COLLECTIONS_POSTER_OPTIONS = { ...COLLECTIONS_POSTER_OPTIONS, ...JSON.parse(savedColl) };
} catch (e) {}

function openCollectionsPosterOptionsModal() {
  const sizeEl = document.getElementById("collections-poster-opt-size");
  if (sizeEl) sizeEl.value = COLLECTIONS_POSTER_OPTIONS.size || "large";
  const progEl = document.getElementById("collections-poster-opt-progress-text");
  if (progEl) progEl.checked = COLLECTIONS_POSTER_OPTIONS.progressText !== false;
  const titleEl = document.getElementById("collections-poster-opt-title");
  if (titleEl) titleEl.checked = COLLECTIONS_POSTER_OPTIONS.title !== false;
  const monEl = document.getElementById("collections-poster-opt-monitored");
  if (monEl) monEl.checked = COLLECTIONS_POSTER_OPTIONS.monitored !== false;
  const partsEl = document.getElementById("collections-poster-opt-parts");
  if (partsEl) partsEl.checked = COLLECTIONS_POSTER_OPTIONS.partsCount !== false;
  openModal("collections-poster-options-modal");
}

function applyCollectionsPosterOptions() {
  COLLECTIONS_POSTER_OPTIONS = {
    size: document.getElementById("collections-poster-opt-size")?.value || "large",
    progressText: document.getElementById("collections-poster-opt-progress-text")?.checked !== false,
    title: document.getElementById("collections-poster-opt-title")?.checked !== false,
    monitored: document.getElementById("collections-poster-opt-monitored")?.checked !== false,
    partsCount: document.getElementById("collections-poster-opt-parts")?.checked !== false
  };
  localStorage.setItem("aliasarr_collections_poster_options", JSON.stringify(COLLECTIONS_POSTER_OPTIONS));
  renderCollectionsView();
}
...
function renderCollectionCard(coll) {
  ...
  // 1. Neo-Glass Style
  if (CURRENT_COLLECTIONS_CARD_STYLE === "neoglass") {
    ...
    return `
      <div class="collection-card show-card" id="collection-card-${coll.id}" data-alpha="${alphaChar}" onclick="openCollectionModal(${coll.id})">
        ...
        ${infoHtml ? `<div class="collection-info-wrap show-info">${infoHtml}</div>` : ""}
      </div>`;
  }
  ...
  if (CURRENT_COLLECTIONS_CARD_STYLE === "cinematic") {
    ...
    return `
      <div class="collection-card show-card" id="collection-card-${coll.id}" data-alpha="${alphaChar}" onclick="openCollectionModal(${coll.id})">
        ...
        <div class="collection-info-wrap show-info cinematic-info">${cinematicInfoHtml}</div>
      </div>`;
  }
...
function renderShowOverviewRow(show) {
  ...
  let editionHtml = "";
  if (show.edition) {
    editionHtml = `<span class="badge-edition"><i data-lucide="clapperboard" class="ico-xxs"></i> ${escapeHtml(show.edition)}</span>`;
  }

  let collectionHtml = "";
  if (show.collection_id && show.collection_title) {
    collectionHtml = `<span class="badge-collection" onclick="event.stopPropagation(); openCollectionModal(${show.collection_id})" title="${CURRENT_LANG === 'en' ? 'Collection' : 'Коллекция'}: ${escapeHtml(show.collection_title)}"><i data-lucide="boxes" class="ico-xxs"></i> ${escapeHtml(show.collection_title)}</span>`;
  }
  ...
  const nextAirBadge = nextAiring ? `<span class="meta-badge meta-badge-next-air"><i data-lucide="calendar" class="ico-xxs"></i> ${t("show.next_airing")}: ${nextAiring}</span>` : "";
...
/* =========================================================================
   SEASON SPLITTER (Разделитель сезона)
   ========================================================================= */

let CURRENT_SEASON_SPLIT_PARTS = [];

function renderSeasonSplitBadges(show, canManageLib = true) {
  const splits = show.season_splits || [];
      ...
      ${splits.map(s => {
        ...
        return `
          <div class="season-split-badge">
            ...
            ${canManageLib ? `
            <div class="season-split-badge-actions">
              <button class="alias-chip-edit" onclick="openSeasonSplitModal(${show.id}, ${s.id})" title="${t("common.edit") || 'Редактировать'}"><i data-lucide="edit-2" class="ico-xs"></i></button>
              <button class="alias-chip-remove" onclick="deleteSeasonSplit(${show.id}, ${s.id})" title="${t("common.delete") || 'Удалить'}"><i data-lucide="trash-2" class="ico-xs"></i></button>
            </div>` : ""}
          </div>
        `;
      }).join("")}
...
function openSeasonSplitModal(showId, splitId = null) {
  ...
  document.getElementById("season-split-id").value = splitId || "";

  const titleEl = document.getElementById("season-split-modal-title");
  if (titleEl) {
    titleEl.textContent = CURRENT_LANG === "en" ? "Season Splitter" : "Разделитель сезона";
  }

  // Populate season select
  const seasonSelect = document.getElementById("season-split-season-select");
  ...
  for (const ep of eps) {
    ...
    if (sn > 0) {
      seasonsMap[sn] = (seasonsMap[sn] || 0) + 1;
    }
  }
  const seasonNums = Object.keys(seasonsMap).map(Number).sort((a, b) => a - b);
  if (!seasonNums.length) seasonNums.push(1);

  for (const sn of seasonNums) {
    const count = seasonsMap[sn] || 0;
    const opt = document.createElement("option");
    opt.value = sn;
    opt.textContent = `${CURRENT_LANG === 'en' ? 'Season' : 'Сезон'} ${sn}${count > 0 ? ` (${count} ${CURRENT_LANG === 'en' ? 'eps' : 'серий'})` : ""}`;
  ...
  openModal("season-split-modal");
  if (typeof lucide !== "undefined" && lucide.createIcons) lucide.createIcons();
}

function renderSeasonSplitParts() {
  ...
  container.innerHTML = CURRENT_SEASON_SPLIT_PARTS.map((p, idx) => {
    ...
    <div class="season-split-part-card" data-index="${idx}">
      <div class="season-split-part-header">
        ...
        <button type="button" class="season-split-part-del-btn" onclick="removeSeasonSplitPart(${idx})" title="${delTitle}">
      ...
      <div class="season-split-fields-grid">
        ...
        <div class="form-group season-split-field-start">
          <label class="form-label">${epStartLabel}</label>
          <input type="number" id="part-start-input-${idx}" class="input input-small" min="1" value="${p.episode_start ?? ''}" placeholder="${idx === 0 ? '1' : '14'}" oninput="onPartStartChange(${idx}, this.value)">
        </div>

        <div class="form-group season-split-field-end">
          <label class="form-label">${epEndLabel}</label>
          <input type="number" id="part-end-input-${idx}" class="input input-small" min="1" value="${p.episode_end ?? ''}" placeholder="${idx === 0 ? '13' : '26'}" oninput="onPartEndChange(${idx}, this.value)">
        </div>

        <div class="form-group season-split-field-aliases">
          <label class="form-label">${aliasesLabel}</label>
          <input type="text" class="input input-small" value="${escapeHtml(p.aliases || '')}" placeholder="${aliasesPlaceholder}" oninput="onPartFieldChange(${idx}, 'aliases', this.value)">
        </div>
      </div>
    </div>
  `;
...
function syncSeasonSplitPartOffsetsAndRanges() {
  for (let i = 0; i < CURRENT_SEASON_SPLIT_PARTS.length; i++) {
    ...
    const startVal = (p.episode_start != null && p.episode_start !== "") ? parseInt(p.episode_start, 10) : 1;
    p.episode_offset = Math.max(0, startVal - 1);
  }
}

function onPartFieldChange(idx, field, val) {
  if (CURRENT_SEASON_SPLIT_PARTS[idx]) {
    CURRENT_SEASON_SPLIT_PARTS[idx][field] = val;
    updateSeasonSplitPreview();
  }
}
...
function onPartStartChange(idx, val) {
  ...
  CURRENT_SEASON_SPLIT_PARTS[idx].episode_offset = !isNaN(startNum) ? Math.max(0, startNum - 1) : 0;
...
function addSeasonSplitPart() {
  ...
  const nextEnd = nextStart != null ? nextStart + 11 : null;
  const nextOffset = nextStart != null ? Math.max(0, nextStart - 1) : 0;

  CURRENT_SEASON_SPLIT_PARTS.push({
    part_type: "season",
    target_number: nextTarget,
    episode_start: nextStart,
    episode_end: nextEnd,
    episode_offset: nextOffset,
    aliases: "",
  });
...
function removeSeasonSplitPart(idx) {
  if (CURRENT_SEASON_SPLIT_PARTS.length <= 1) return;
  CURRENT_SEASON_SPLIT_PARTS.splice(idx, 1);
  renderSeasonSplitParts();
  updateSeasonSplitPreview();
}
...
function updateSeasonSplitPreview() {
  const content = document.getElementById("season-split-preview-content");
  if (!content) return;
  ...
  if (!CURRENT_SEASON_SPLIT_PARTS.length) {
    content.innerHTML = `<em>${CURRENT_LANG === "en" ? "No parts configured" : "Нет настроенных частей"}</em>`;
    return;
  }
  ...
  const lines = CURRENT_SEASON_SPLIT_PARTS.map((p, idx) => {
    ...
    const s = start || 1;
    const e = end || s;
    const off = Math.max(0, s - 1);
    p.episode_offset = off;

    const relStart = Math.max(1, s - off);
    const relEnd = Math.max(relStart, e - off);

    const relEpStr = (relStart === relEnd) ? pad(relStart) : `${pad(relStart)}–${pad(relEnd)}`;
    const libEpStr = (s === e) ? `${sStr}E${pad(s)}` : `${sStr}E${pad(s)}–${sStr}E${pad(e)}`;
...
async function saveSeasonSplit() {
  const showId = document.getElementById("season-split-show-id").value;
  const splitId = document.getElementById("season-split-id").value;
  const seasonNumber = parseInt(document.getElementById("season-split-season-select").value, 10) || 1;
  const name = CURRENT_LANG === "en" ? `Season ${seasonNumber}` : `Сезон ${seasonNumber}`;

  if (!CURRENT_SEASON_SPLIT_PARTS.length) {
    toast(CURRENT_LANG === "en" ? "At least one part is required" : "Добавьте хотя бы одну часть", true);
    return;
  }
  ...
  try {
    const url = splitId
      ? `/api/v1/shows/${showId}/season-splits/${splitId}`
      : `/api/v1/shows/${showId}/season-splits`;
    const method = splitId ? "PUT" : "POST";
    ...
    closeModal("season-split-modal");
    await refreshShowModal();
    await loadShows();
    toast(CURRENT_LANG === "en" ? "Season split saved successfully" : "Разделитель сезона успешно сохранён");
  } catch (e) {
    toast((CURRENT_LANG === "en" ? "Error: " : "Ошибка: ") + e.message, true);
  }
}

async function deleteCurrentSeasonSplit() {
  const showId = document.getElementById("season-split-show-id").value;
  const splitId = document.getElementById("season-split-id").value;
  if (!splitId) return;

  await deleteSeasonSplit(showId, splitId);
  closeModal("season-split-modal");
}

async function deleteSeasonSplit(showId, splitId) {
  if (!confirm(CURRENT_LANG === "en" ? "Delete this season split rule?" : "Удалить этот разделитель сезона?")) {
    return;
  }

  try {
    await api(`/api/v1/shows/${showId}/season-splits/${splitId}`, {
      method: "DELETE",
    });
    await refreshShowModal();
    await loadShows();
    toast(CURRENT_LANG === "en" ? "Season split deleted" : "Разделитель сезона удалён");
  } catch (e) {
    toast((CURRENT_LANG === "en" ? "Error: " : "Ошибка: ") + e.message, true);
  }
}
...
async function loadGroupedReleaseHistory(page) {
  ...
  try {
    ...
    // Strict Show-Centric Grouping: 1 Group = 1 Show
    const groupsMap = new Map();

    for (const item of rawLogs) {
      const showId = item.show_id != null ? String(item.show_id) : null;
      const key = showId ? `show_${showId}` : (item.show_title ? `title_${item.show_title.toLowerCase().trim()}` : `unlinked`);

      if (!groupsMap.has(key)) {
        const sObj = item.show_id ? showsMap[item.show_id] : null;
        groupsMap.set(key, {
          key: key,
          show_id: item.show_id || null,
          show_title: item.show_title || sObj?.title || "",
          show_obj: sObj || null,
          items: [],
          stages: new Set(),
          indexers: new Set(),
      ...
      if (!grp.show_id && item.show_id) {
        grp.show_id = item.show_id;
        if (showsMap[item.show_id]) grp.show_obj = showsMap[item.show_id];
      }
      if (!grp.show_title && item.show_title) grp.show_title = item.show_title;
      if (grp.show_id && !grp.show_obj && showsMap[grp.show_id]) grp.show_obj = showsMap[grp.show_id];

      if (item.stage) grp.stages.add(item.stage);
      if (item.indexer) grp.indexers.add(item.indexer);
    ...
    // Helper to finalize each cycle status and trigger
    function finalizeCycle(cycle) {
      const hasImport = cycle.items.some(x => x.stage === "import" && x.level === "success");
      const hasGrab = cycle.items.some(x => x.stage === "grab" && x.level === "success");
      const hasError = cycle.items.some(x => x.level === "error");
      const hasWarning = cycle.items.some(x => x.level === "warning" || x.stage === "filter" || (x.stage === "decision" && x.level === "warning"));

      if (hasImport) {
        cycle.status = "imported";
      } else if (hasGrab) {
        cycle.status = "grabbed";
      } else if (hasError) {
        cycle.status = "error";
      } else if (hasWarning) {
      ...
      if (!cycle.trigger) {
        if (cycle.items.some(x => (x.message || "").toLowerCase().includes("ручной") || (x.message || "").toLowerCase().includes("manual"))) {
          cycle.trigger = "manual_search";
        } else if (cycle.items.some(x => (x.message || "").toLowerCase().includes("добавлен") || (x.message || "").toLowerCase().includes("каталог"))) {
          cycle.trigger = "add_show";
        } else if (cycle.items.some(x => x.stage === "import")) {
          cycle.trigger = "import";
        } else {
          cycle.trigger = "auto_search";
        }
      }
    }

    // Process cycles and determine overall status for each show
    for (const grp of groups) {
      ...
      for (let i = 0; i < grp.items.length; i++) {
        ...
        if (!currentCycle) {
          ...
          if (it.session_id && currentCycle.session_id && it.session_id !== currentCycle.session_id) {
            isNewCycle = true;
          } else if (!it.session_id && !currentCycle.session_id) {
            const prevIt = currentCycle.items[currentCycle.items.length - 1];
            const timeDiff = new Date(it.created_at) - new Date(prevIt.created_at);
            if (timeDiff > 20 * 60 * 1000) {
              isNewCycle = true;
            } else if (it.stage === "search" && currentCycle.items.some(x => x.stage === "grab" || x.stage === "import" || x.stage === "decision")) {
              isNewCycle = true;
            }
          } else if (it.session_id && !currentCycle.session_id) {
            isNewCycle = true;
        ...
        if (isNewCycle) {
          if (currentCycle) {
            finalizeCycle(currentCycle);
            cyclesList.push(currentCycle);
          }
          currentCycle = {
            id: it.session_id || `cycle_${cyclesList.length + 1}`,
        ...
        currentCycle.items.push(it);
        if (it.stage) currentCycle.stages.add(it.stage);
        if (it.indexer) currentCycle.indexers.add(it.indexer);
        if (it.created_at) currentCycle.latest_at = it.created_at;
        if (!currentCycle.trigger && it.trigger) currentCycle.trigger = it.trigger;

        if (!currentCycle.torrent_hash && it.details && (it.details.torrent_hash || it.details.hash || it.details.info_hash)) {
          currentCycle.torrent_hash = it.details.torrent_hash || it.details.hash || it.details.info_hash;
        }
        if (!currentCycle.link_url && it.details && (it.details.page_url || it.details.download_url)) {
          currentCycle.link_url = it.details.page_url || it.details.download_url;
        }
        if (it.release_title && !currentCycle.winner_release && (it.stage === "grab" || it.stage === "import" || it.stage === "decision")) {
          currentCycle.winner_release = it.release_title;
        }
      }
      ...
      cyclesList.sort((a, b) => new Date(b.latest_at) - new Date(a.latest_at));
      grp.cycles = cyclesList;

      if (cyclesList.length > 0) {
        grp.status = cyclesList[0].status;
        grp.latest_time = cyclesList[0].latest_at;
      }
    }
    ...
    const filtered = groups.filter(g => {
      ...
      if (searchVal) {
        ...
        const inIdx = Array.from(g.indexers).some(idx => idx.toLowerCase().includes(searchVal));
        const inMsgs = g.items.some(it => (it.message || "").toLowerCase().includes(searchVal) || (it.release_title || "").toLowerCase().includes(searchVal));
        if (!inShow && !inIdx && !inMsgs) return false;
      }
      return true;
    });
    ...
    const triggerConfig = {
      ...
      monitor: { label: isRu ? "Мониторинг загрузки" : "Download Monitor", icon: "hard-drive", cls: "trigger-auto" }
    };

    container.innerHTML = pageItems.map((grp, idxInPage) => {
      const globalIdx = startIdx + idxInPage;
      const sObj = grp.show_obj || (grp.show_id ? showsMap[grp.show_id] : null);
      ...
      const indexerPills = Array.from(grp.indexers).map(idx => {
        return `<span class="cycle-idx-tag">[${escapeHtml(idx)}]</span>`;
      }).join(" ");

      const contentBadge = sObj?.content_type === "movie"
        ? `<span class="category-badge-chip category-badge-movies">${isRu ? "Фильм" : "Movie"}</span>`
        : (sObj?.content_type === "anime"
          ? `<span class="category-badge-chip category-badge-anime">${isRu ? "Аниме" : "Anime"}</span>`
          : (sObj?.content_type ? `<span class="category-badge-chip category-badge-series">${isRu ? "Сериал" : "Series"}</span>` : ""));

      const cyclesCount = grp.cycles.length;
      const cyclesCountText = isRu
        ? `${cyclesCount} ${cyclesCount === 1 ? "запуск" : (cyclesCount < 5 ? "запуска" : "запусков")}`
        ...
        <div class="history-release-card status-${grp.status}" onclick="openReleaseHistoryDrawer(${globalIdx})">
          <div class="history-release-header">
            <div class="history-release-title-row">
              ...
              <div class="history-release-meta">
                ...
                <div class="history-release-cycle-summary">
                  <span class="hint" style="display:inline-flex; align-items:center; gap:4px;"><i data-lucide="layers" style="width:12px; height:12px;"></i> ${cyclesCountText}</span>
                  ${trigPill}
                  ${indexerPills}
                </div>
              </div>
            ...
            <div class="history-card-right">
              ...
              <div class="history-card-action-btns" onclick="event.stopPropagation()">
                <button type="button" class="btn-icon-soft" onclick="downloadReleaseLogs(${grp.show_id || 'null'}, '${escapeHtml(showTitleText)}')" title="${isRu ? 'Скачать лог тайтла в .txt' : 'Download title log (.txt)'}">
                  <i data-lucide="download" class="ico-xs"></i>
                </button>
                <button type="button" class="btn-icon-soft text-danger" onclick="clearReleaseLogs(${grp.show_id || 'null'}, '${escapeHtml(showTitleText)}')" title="${isRu ? 'Очистить историю этого тайтла' : 'Clear title history'}">
                  <i data-lucide="trash-2" class="ico-xs"></i>
                </button>
              </div>
            </div>
          ...
          <div class="history-release-badges-row">
            ...
            <span class="history-release-action-btn">
              <span>${isRu ? "История циклов" : "Lifecycle History"}</span>
...
function openReleaseHistoryDrawer(globalIdx) {
  ...
  const isRu = CURRENT_LANG !== "en";
  const sObj = grp.show_obj || (grp.show_id ? (CACHED_SHOWS || []).find(s => s.id == grp.show_id) : null);
  const showTitleText = grp.show_title || sObj?.title || (isRu ? "Без привязки к тайтлу" : "Unlinked");

  if (titleEl) titleEl.textContent = showTitleText;
  if (subtitleEl) subtitleEl.textContent = isRu ? "История жизненных циклов и решений" : "Lifecycle runs & decision timeline";
  ...
  const heroHtml = `
    <div class="drawer-hero-card">
      <div class="drawer-hero-top">
        ...
        <div class="drawer-hero-info">
          ...
          <div style="display:flex; gap:6px; flex-wrap:wrap; align-items:center; margin-top:6px;">
            ${statusBadge}
            <span class="badge badge-secondary mono" style="font-size:11px;"><i data-lucide="layers" style="width:11px; height:11px; display:inline-block; vertical-align:middle;"></i> ${cyclesCountText}</span>
            <span class="mono hint" style="font-size:11px; margin-left:auto;">${formatDateTZ(grp.latest_time)}</span>
          </div>
          ${sObj?.path ? `<div class="hint mono text-xs" style="margin-top:6px; word-break:break-all; opacity:0.85;">${escapeHtml(sObj.path)}</div>` : ""}
        </div>
      </div>
      <div class="drawer-hero-actions">
        ...
        ` : ""}
        <button type="button" class="btn btn-secondary btn-small" onclick="downloadReleaseLogs(${grp.show_id || 'null'}, '${escapeHtml(showTitleText)}')" title="${isRu ? 'Скачать лог тайтла в .txt' : 'Download title log (.txt)'}">
          <i data-lucide="download" class="ico-xs"></i>
          <span>${isRu ? "Скачать .txt тайтла" : "Download .txt"}</span>
        </button>
        <button type="button" class="btn btn-danger btn-small" onclick="clearReleaseLogs(${grp.show_id || 'null'}, '${escapeHtml(showTitleText)}')" title="${isRu ? 'Очистить историю этого тайтла' : 'Clear title history'}">
          <i data-lucide="trash-2" class="ico-xs"></i>
          <span>${isRu ? "Очистить логи тайтла" : "Clear logs"}</span>
        </button>
      </div>
    </div>
  `;
  ...
  const cyclesHtml = grp.cycles.map((cycle, cycleIdx) => {
    ...
    if (cycle.status === "imported") {
      cycleStatusBadge = `<span class="badge badge-ok" style="font-size:10px; padding:2px 6px;">${isRu ? "Импортирован" : "Imported"}</span>`;
    } else if (cycle.status === "grabbed") {
      cycleStatusBadge = `<span class="badge badge-teal" style="font-size:10px; padding:2px 6px;">${isRu ? "Захвачен" : "Grabbed"}</span>`;
    } else if (cycle.status === "rejected") {
      cycleStatusBadge = `<span class="badge badge-warn" style="font-size:10px; padding:2px 6px;">${isRu ? "Отклонён" : "Rejected"}</span>`;
    } else if (cycle.status === "error") {
      cycleStatusBadge = `<span class="badge badge-error" style="font-size:10px; padding:2px 6px;">${isRu ? "Ошибка" : "Error"}</span>`;
    } else {
      cycleStatusBadge = `<span class="badge badge-info" style="font-size:10px; padding:2px 6px;">${isRu ? "Инфо" : "Info"}</span>`;
    }

    const indexerTags = Array.from(cycle.indexers).map(idx => `<span class="cycle-idx-tag">${escapeHtml(idx)}</span>`).join(" ");

    // Timeline Steps for this cycle
    const stepsHtml = cycle.items.map((item, stepIdx) => {
      ...
      if (item.details && Array.isArray(item.details.rejected_sample) && item.details.rejected_sample.length > 0) {
        ...
        subDetailsHtml += `
          <div style="margin-top:8px;">
            <div style="font-weight:600; font-size:12px; margin-bottom:4px; display:flex; align-items:center; gap:6px; color:#f59e0b;">
              <i data-lucide="filter-x" style="width:13px; height:13px;"></i>
              <span>${isRu ? "Отклонённые фильтрами раздачи" : "Filtered / Rejected Releases"}</span>
              <span class="hint" style="font-size:10.5px;">(${item.details.rejected_count || item.details.rejected_sample.length})</span>
            </div>
            <div style="max-height:160px; overflow-y:auto; border:1px solid var(--border); border-radius:6px; background:var(--panel);">
              ${rejItems}
            </div>
          </div>
        `;
      ...
      // 5. Torrent Hash pill with Copy button
      const itemHash = item.details?.torrent_hash || item.details?.hash || item.details?.info_hash;
      const itemUrl = item.details?.page_url || item.details?.download_url;
      if (itemHash || itemUrl) {
        subDetailsHtml += `
          <div style="margin-top:8px; display:flex; gap:8px; align-items:center; flex-wrap:wrap;">
            ${itemHash ? `
              <div class="blocklist-pill" style="font-size:11px;" title="Infohash: ${escapeHtml(itemHash)}">
                <i data-lucide="hash" class="ico-xxs text-muted"></i>
                <code>${escapeHtml(itemHash.slice(0, 8))}...${escapeHtml(itemHash.slice(-4))}</code>
                <button type="button" class="btn-icon-xxs" onclick="copyBlocklistHash('${escapeHtml(itemHash)}', this)" title="${isRu ? 'Скопировать хэш' : 'Copy hash'}">
                  <i data-lucide="copy" class="ico-xxs"></i>
                </button>
              </div>
            ` : ""}
            ${itemUrl ? `
              <a href="${escapeHtml(itemUrl)}" target="_blank" rel="noopener noreferrer" class="btn btn-secondary btn-small" style="font-size:11px; padding:2px 8px;" title="${isRu ? 'Открыть страницу раздачи' : 'Open release page'}">
                <i data-lucide="external-link" class="ico-xxs"></i>
                <span>${item.indexer || (isRu ? "Трекер" : "Tracker")}</span>
              </a>
            ` : ""}
          </div>
        `;
      ...
      // 6. Technical JSON context (collapsed)
    ...
    return `
      <div class="drawer-cycle-card ${isFirst ? 'open' : ''}" id="cycle-card-${cycleIdx}">
        <div class="drawer-cycle-header" onclick="toggleCycleCard('cycle-card-${cycleIdx}')">
          <div class="drawer-cycle-header-left">
            <div class="cycle-trigger-icon-badge ${trigConf.cls}">
              <i data-lucide="${trigConf.icon}"></i>
            </div>
            <div class="drawer-cycle-title-wrap">
              <div class="drawer-cycle-heading">
                <span class="drawer-cycle-trigger-name">${trigConf.label}</span>
                ${cycleStatusBadge}
              </div>
              <div class="drawer-cycle-meta-line">
                <span class="mono">${formatDateTZ(cycle.started_at)}</span>
                ${indexerTags}
              </div>
            </div>
          </div>
          <div class="drawer-cycle-header-right">
            <span class="badge-tag mono">${cycle.items.length} ${isRu ? "шагов" : "steps"}</span>
            <i data-lucide="chevron-down" class="cycle-toggle-chevron"></i>
          </div>
        </div>
        <div class="drawer-cycle-body">
  ...
  const accordionHtml = `
    <div class="drawer-cycles-accordion">
      <div class="drawer-cycles-title-row">
        <div style="display:flex; align-items:center; gap:8px; font-weight:700; font-size:13.5px; color:var(--text);">
          ...
          <span>${isRu ? "История жизненных циклов (запусков)" : "Lifecycle Runs & Sessions"}</span>
        </div>
        <span class="hint" style="font-size:11.5px;">${grp.cycles.length} ${isRu ? (grp.cycles.length === 1 ? "запуск" : (grp.cycles.length < 5 ? "запуска" : "запусков")) : (grp.cycles.length === 1 ? "run" : "runs")}</span>
      </div>
      ${cyclesHtml}
    </div>
  `;

  bodyEl.innerHTML = heroHtml + accordionHtml;
...
function toggleCycleCard(cardId) {
...
function quickBlocklistFromHistory(globalIdx) {
  ...
  setTimeout(() => {
    ...
    if (titleInput) titleInput.value = grp.show_title || "";
...
async function downloadReleaseLogs(showId, showTitle) {
  const isRu = CURRENT_LANG !== "en";
  try {
    let url = "/api/v1/release-logs/export";
    let filename = `aliasarr_release_logs_${new Date().toISOString().slice(0, 10)}.txt`;
    if (showId) {
      url += `?show_id=${encodeURIComponent(showId)}`;
      const safeTitle = (showTitle || `show_${showId}`).replace(/[^\w\-_.]/g, "_").slice(0, 30);
      filename = `aliasarr_logs_${safeTitle}_${new Date().toISOString().slice(0, 10)}.txt`;
    }
    ...
    toast(showTitle ? (isRu ? `Логи тайтла «${showTitle}» скачаны` : `Logs downloaded for «${showTitle}»`) : (isRu ? "Логи релизов скачаны" : "Logs downloaded"));
  } catch (e) {
    toast((isRu ? "Ошибка скачивания: " : "Download error: ") + e.message, true);
  }
}

async function clearReleaseLogs(showId, showTitle) {
  const isRu = CURRENT_LANG !== "en";
  const confirmMsg = showId
    ? (isRu ? `Очистить историю релизов для тайтла «${showTitle || showId}»?` : `Clear release history for «${showTitle || showId}»?`)
    : (isRu ? "Очистить весь журнал истории релизов?" : "Clear all release history logs?");

  const confirmed = await confirmModal(confirmMsg);
  if (!confirmed) return;

  try {
    let url = "/api/v1/release-logs";
    if (showId) {
      url += `?show_id=${encodeURIComponent(showId)}`;
    }
    await api(url, { method: "DELETE" });
    const successMsg = showId
      ? (isRu ? `История тайтла «${showTitle || showId}» очищена` : `History for «${showTitle || showId}» cleared`)
      : (isRu ? "Журнал релизов очищен" : "Release logs cleared");
    toast(successMsg);

    closeReleaseHistoryDrawer();
    await loadGroupedReleaseHistory(1);
  } catch (e) {
    toast((isRu ? "Ошибка очистки: " : "Clear error: ") + e.message, true);
  }
}
...
let BLOCKLIST_SIDEBAR_QUERY = "";
let BLOCKLIST_SELECTED_REASON = "all";
let BLOCKLIST_SELECTED_IDS = new Set();
...
// Helper to categorize reason for badge colors & filtering
function getBlocklistReasonCategory(reasonStr) {
  const r = (reasonStr || "").toLowerCase();
  if (r.includes("сид") || r.includes("seed") || r.includes("dead") || r.includes("stalled") || r.includes("нет сидов")) {
    return { category: "no_seeds", cls: "reason-amber", icon: "clock-alert", label: CURRENT_LANG === "en" ? "No seeders" : "Нет сидов" };
  }
  if (r.includes("отклон") || r.includes("ошибк") || r.includes("fail") || r.includes("error") || r.includes("cannot access") || r.includes("parse") || r.includes("исключен")) {
    return { category: "error", cls: "reason-rose", icon: "alert-octagon", label: CURRENT_LANG === "en" ? "Import error" : "Ошибка импорта" };
  }
  if (r.includes("звук") || r.includes("озвучк") || r.includes("аудио") || r.includes("audio") || r.includes("lang") || r.includes("язык") || r.includes("mvo") || r.includes("dvo") || r.includes("нет ru")) {
    return { category: "audio", cls: "reason-orange", icon: "volume-x", label: CURRENT_LANG === "en" ? "Audio / Language" : "Озвучка / Язык" };
  }
  if (r.includes("вручн") || r.includes("manual") || r.includes("пользовател")) {
    return { category: "manual", cls: "reason-purple", icon: "user-x", label: CURRENT_LANG === "en" ? "Manual block" : "Вручную" };
  }
  if (r.includes("качество") || r.includes("score") || r.includes("custom format") || r.includes("профиль") || r.includes("quality")) {
    return { category: "quality", cls: "reason-blue", icon: "sliders", label: CURRENT_LANG === "en" ? "Quality / CF" : "Качество / CF" };
  }
  return { category: "other", cls: "reason-amber", icon: "alert-circle", label: reasonStr || (CURRENT_LANG === "en" ? "Blocked" : "Заблокировано") };
}

function setBlocklistViewMode(mode) {
  BLOCKLIST_OPTIONS.viewMode = mode;
  try {
...
function setBlocklistReasonFilter(category) {
  BLOCKLIST_SELECTED_REASON = category;
  renderBlocklist();
}

function onBlocklistSidebarSearchInput() {
  const input = document.getElementById("blocklist-sidebar-search-input");
  BLOCKLIST_SIDEBAR_QUERY = (input ? input.value : "").toLowerCase().trim();
  renderBlocklist();
}
...
function toggleBlocklistItemSelection(id) {
  if (BLOCKLIST_SELECTED_IDS.has(id)) {
    BLOCKLIST_SELECTED_IDS.delete(id);
  } else {
    BLOCKLIST_SELECTED_IDS.add(id);
  }
  updateBlocklistBatchUI();
}

function toggleBlocklistSelectAll(forcedState) {
  const currentFiltered = getFilteredBlocklistData();
  const shouldSelect = (forcedState !== undefined)
    ? forcedState
    : (BLOCKLIST_SELECTED_IDS.size < currentFiltered.length);

  BLOCKLIST_SELECTED_IDS.clear();
  if (shouldSelect) {
    for (const item of currentFiltered) {
      BLOCKLIST_SELECTED_IDS.add(item.id);
    }
  }
  updateBlocklistBatchUI();
}

function clearBlocklistSelection() {
  BLOCKLIST_SELECTED_IDS.clear();
  updateBlocklistBatchUI();
}

function updateBlocklistBatchUI() {
  const batchBar = document.getElementById("blocklist-batch-bar");
  const batchCount = document.getElementById("blocklist-batch-count");
  const count = BLOCKLIST_SELECTED_IDS.size;
  ...
  // Update card selected classes and checkboxes
  document.querySelectorAll(".blocklist-card").forEach(el => {
    const id = parseInt(el.getAttribute("data-id"), 10);
    const isSel = BLOCKLIST_SELECTED_IDS.has(id);
    el.classList.toggle("selected", isSel);
    const cb = el.querySelector(".blocklist-card-cb");
    if (cb) cb.checked = isSel;
  });

  // Update table row selected states and checkboxes
  document.querySelectorAll(".blocklist-table-cb").forEach(cb => {
    const id = parseInt(cb.getAttribute("data-id"), 10);
    cb.checked = BLOCKLIST_SELECTED_IDS.has(id);
  });

  const checkAll = document.getElementById("blocklist-table-check-all");
  const currentFiltered = getFilteredBlocklistData();
  if (checkAll) {
    checkAll.checked = (currentFiltered.length > 0 && BLOCKLIST_SELECTED_IDS.size === currentFiltered.length);
    checkAll.indeterminate = (BLOCKLIST_SELECTED_IDS.size > 0 && BLOCKLIST_SELECTED_IDS.size < currentFiltered.length);
  }
}

async function unblockSelectedBlocklistItems() {
  const ids = Array.from(BLOCKLIST_SELECTED_IDS);
  if (!ids.length) return;

  const msg = CURRENT_LANG === "en"
    ? `Are you sure you want to unblock ${ids.length} selected releases?`
    : `Вы уверены, что хотите разблокировать ${ids.length} выбранных раздач?`;
  ...
  for (const id of ids) {
    try {
      ...
      console.error(`Failed to unblock item #${id}:`, e);
    }
  }

  showToast(
    (CURRENT_LANG === "en" ? `Selected releases unblocked (${successCount})` : `Выбранные раздачи разблокированы (${successCount})`),
    "success"
  );
  BLOCKLIST_DATA = BLOCKLIST_DATA.filter(x => !BLOCKLIST_SELECTED_IDS.has(x.id));
  BLOCKLIST_SELECTED_IDS.clear();
  renderBlocklist();
}

function copyBlocklistHash(hash, btnEl) {
  if (!hash) return;
  navigator.clipboard.writeText(hash).then(() => {
    showToast(CURRENT_LANG === "en" ? "Infohash copied to clipboard" : "Инфохэш скопирован в буфер", "success");
    if (btnEl) {
      const origHtml = btnEl.innerHTML;
      btnEl.innerHTML = `<i data-lucide="check" class="ico-xxs text-success"></i>`;
      if (window.lucide) lucide.createIcons();
      setTimeout(() => {
    ...
    showToast(CURRENT_LANG === "en" ? "Failed to copy hash" : "Ошибка копирования хэша", "error");
  });
}
...
async function loadBlocklist(preferredShowId) {
  ...
  const cardsGrid = document.getElementById("blocklist-cards-grid");
  const tableBody = document.getElementById("blocklist-table-body");
  const loadingHtml = `<div style="text-align:center; padding:32px; color:var(--text-muted); grid-column:1/-1;"><i data-lucide="loader-2" class="spin ico-md" style="display:inline-block; vertical-align:middle; margin-right:8px;"></i>${CURRENT_LANG === "en" ? "Loading blocklist..." : "Загрузка черного списка..."}</div>`;

  if (cardsGrid) cardsGrid.innerHTML = loadingHtml;
  if (tableBody) tableBody.innerHTML = `<tr><td colspan="6" style="text-align:center; padding:32px; color:var(--text-muted);"><i data-lucide="loader-2" class="spin ico-md" style="display:inline-block; vertical-align:middle; margin-right:8px;"></i>${CURRENT_LANG === "en" ? "Loading blocklist..." : "Загрузка черного списка..."}</td></tr>`;
  if (window.lucide) lucide.createIcons();
...
function getFilteredBlocklistData() {
  return BLOCKLIST_DATA.filter(item => {
    // 1. Show filter
    ...
    if (BLOCKLIST_SELECTED_REASON !== "all") {
      const cat = getBlocklistReasonCategory(item.reason).category;
      if (cat !== BLOCKLIST_SELECTED_REASON) return false;
    }
...
function renderBlocklistReasonFilterChips(reasonCounts, totalInShow) {
  const container = document.getElementById("blocklist-reason-filters");
  if (!container) return;

  const filters = [
    { id: "all", label: CURRENT_LANG === "en" ? "All" : "Все", icon: "layers", count: totalInShow, cls: "" },
    { id: "no_seeds", label: CURRENT_LANG === "en" ? "No Seeds" : "Нет сидов", icon: "clock-alert", count: reasonCounts.no_seeds || 0, cls: "chip-amber" },
    { id: "error", label: CURRENT_LANG === "en" ? "Import Error" : "Ошибка импорта", icon: "alert-octagon", count: reasonCounts.error || 0, cls: "chip-rose" },
    { id: "audio", label: CURRENT_LANG === "en" ? "Audio / Language" : "Озвучка / Язык", icon: "volume-x", count: reasonCounts.audio || 0, cls: "chip-orange" },
    { id: "manual", label: CURRENT_LANG === "en" ? "Manual" : "Вручную", icon: "user-x", count: reasonCounts.manual || 0, cls: "chip-purple" },
    { id: "quality", label: CURRENT_LANG === "en" ? "Quality / CF" : "Качество / CF", icon: "sliders", count: reasonCounts.quality || 0, cls: "chip-blue" }
  ];

  container.innerHTML = filters.map(f => {
    const isActive = BLOCKLIST_SELECTED_REASON === f.id;
    return `
      <div class="blocklist-reason-chip ${f.cls} ${isActive ? 'active' : ''}" onclick="setBlocklistReasonFilter('${f.id}')">
        <i data-lucide="${f.icon}" class="ico-xs"></i>
...
function renderBlocklist() {
  ...
  const sidebarSearchWrap = document.getElementById("blocklist-sidebar-search-wrap");
  ...
  const cardsWrap = document.getElementById("blocklist-cards-wrap");
  const cardsGrid = document.getElementById("blocklist-cards-grid");
  ...
  // Count items per show and reason categories
  const showCounts = {};
  const reasonCounts = { all: 0, no_seeds: 0, error: 0, audio: 0, manual: 0, quality: 0, other: 0 };
  let totalForCurrentShow = 0;

  for (const item of BLOCKLIST_DATA) {
    const sid = item.show_id != null ? item.show_id : "unlinked";
    showCounts[sid] = (showCounts[sid] || 0) + 1;

    // Check if belongs to current show
    const belongsToCurrent = (SELECTED_BLOCKLIST_SHOW_ID === "all") ||
      (SELECTED_BLOCKLIST_SHOW_ID === "unlinked" && item.show_id == null) ||
      (String(item.show_id) === String(SELECTED_BLOCKLIST_SHOW_ID));
  ...
  if (sidebarSearchWrap) {
    sidebarSearchWrap.style.display = uniqueShowIds.length > 5 ? "flex" : "none";
  }

  // Render reason filter chips
  renderBlocklistReasonFilterChips(reasonCounts, totalForCurrentShow);
  ...
  if (sidebarList) {
    ...
    const allIcon = `<div class="blocklist-show-poster placeholder"><i data-lucide="layers" class="ico-sm text-teal"></i></div>`;
    let sidebarHtml = `
    ...
    for (const sid of uniqueShowIds) {
      ...
      if (BLOCKLIST_SIDEBAR_QUERY && !title.toLowerCase().includes(BLOCKLIST_SIDEBAR_QUERY)) {
        continue;
      }
      ...
      sidebarHtml += `
        <div class="blocklist-show-item ${isActive ? 'active' : ''}" onclick="selectBlocklistShow('${escapeHtml(String(sid))}')">
          ...
          <div class="blocklist-show-info">
            ...
            ${sObj?.year ? `<div class="blocklist-show-meta"><span class="badge-subtle">${sObj.year}</span>${sObj.type ? `<span class="badge-subtle">${sObj.type}</span>` : ''}</div>` : ""}
          </div>
  ...
  // Filter items
  const filtered = getFilteredBlocklistData();
  if (currentCountEl) currentCountEl.textContent = filtered.length;

  // Action buttons visibility
  if (clearShowBtn) {
    clearShowBtn.style.display = (SELECTED_BLOCKLIST_SHOW_ID !== "all" && filtered.length > 0) ? "inline-flex" : "none";
  }
  if (addShowBtn) {
...
function renderBlocklistCards(filtered, showsMap, container) {
  if (!container) return;
  ...
  container.innerHTML = filtered.map(item => {
    ...
    const reasonInfo = getBlocklistReasonCategory(item.reason);
    const isSelected = BLOCKLIST_SELECTED_IDS.has(item.id);
    const linkUrl = item.page_url || (item.guid && (item.guid.startsWith("http://") || item.guid.startsWith("https://")) ? item.guid : "");

    const showBadgeHtml = showTitle ? `
      <a href="javascript:void(0)" onclick="openShowModal(${sid})" class="blocklist-card-show-badge" title="${escapeHtml(showTitle)}">
        <i data-lucide="film" class="ico-xs text-teal"></i>
        <span>${escapeHtml(showTitle)}</span>
        ${sObj?.year ? `<span class="text-muted text-xs font-normal">(${sObj.year})</span>` : ""}
      </a>
    ` : `
      <span class="blocklist-card-show-badge" style="opacity:0.7;">
        <i data-lucide="shield-alert" class="ico-xs text-danger"></i>
        <span>${CURRENT_LANG === 'en' ? 'Global block' : 'Глобальная'}</span>
      </span>
    `;

    const hashPill = item.torrent_hash ? `
      <div class="blocklist-pill" title="Infohash: ${escapeHtml(item.torrent_hash)}">
        <i data-lucide="hash" class="ico-xxs text-muted"></i>
        <code>${escapeHtml(item.torrent_hash.slice(0, 8))}...${escapeHtml(item.torrent_hash.slice(-4))}</code>
        <button type="button" class="btn-icon-xxs" onclick="copyBlocklistHash('${escapeHtml(item.torrent_hash)}', this)" title="${CURRENT_LANG === 'en' ? 'Copy infohash' : 'Скопировать инфохэш'}">
          <i data-lucide="copy" class="ico-xxs"></i>
        </button>
      </div>
    ` : "";

    const sizePill = (item.size && item.size > 0) ? `
      <div class="blocklist-pill">
        <i data-lucide="hard-drive" class="ico-xxs text-muted"></i>
        <span>${formatBytes(item.size)}</span>
      </div>
    ` : "";

    const linkPill = linkUrl ? `
      <a href="${escapeHtml(linkUrl)}" target="_blank" rel="noopener noreferrer" class="blocklist-pill link-pill" title="${CURRENT_LANG === 'en' ? 'Open tracker page' : 'Открыть раздачу на трекере'}">
        <i data-lucide="external-link" class="ico-xxs"></i>
        <span>${escapeHtml(item.indexer || (CURRENT_LANG === 'en' ? 'Tracker' : 'Трекер'))}</span>
      </a>
    ` : "";

    return `
      <div class="blocklist-card ${reasonInfo.cls} ${isSelected ? 'selected' : ''}" data-id="${item.id}">
        <div class="blocklist-card-top">
          <div class="blocklist-card-select-wrap">
            <input type="checkbox" class="blocklist-card-cb" data-id="${item.id}" ${isSelected ? 'checked' : ''} onchange="toggleBlocklistItemSelection(${item.id})">
            ${showBadgeHtml}
          </div>
          <div class="blocklist-card-badges">
            ${item.indexer ? `<span class="badge badge-secondary mono-code">${escapeHtml(item.indexer)}</span>` : ""}
            ${item.quality ? `<span class="badge badge-teal mono-code">${escapeHtml(item.quality)}</span>` : ""}
          </div>
        </div>

        <div class="blocklist-card-body">
          <div class="blocklist-card-title" title="${escapeHtml(relTitle)}">${escapeHtml(relTitle)}</div>
          <div class="blocklist-card-pills">
            ${hashPill}
            ${sizePill}
            ${linkPill}
          </div>
        ...
        <div class="blocklist-reason-box ${reasonInfo.cls}">
          <div class="blocklist-reason-box-left">
            <i data-lucide="${reasonInfo.icon}" class="ico-sm"></i>
            <div class="blocklist-reason-text">${escapeHtml(item.reason || reasonInfo.label)}</div>
          </div>
          <div class="blocklist-reason-date" title="${escapeHtml(dateStr)}">${escapeHtml(dateStr.split(',')[0] || dateStr)}</div>
        </div>

        <div class="blocklist-card-footer">
          <button type="button" class="btn btn-secondary btn-small" onclick="openEditBlocklistModal(${item.id})" title="${CURRENT_LANG === 'en' ? 'Edit parameters' : 'Редактировать параметры'}">
            <i data-lucide="edit-3" class="ico-xs"></i> <span>${CURRENT_LANG === 'en' ? 'Edit' : 'Изменить'}</span>
          </button>
          <button type="button" class="btn btn-small btn-unblock" onclick="removeBlocklistItem(${item.id})" title="${CURRENT_LANG === 'en' ? 'Unblock and remove from blocklist' : 'Разблокировать и удалить из черного списка'}">
            <i data-lucide="shield-check" class="ico-xs"></i> <span>${CURRENT_LANG === 'en' ? 'Unblock' : 'Разблокировать'}</span>
          </button>
        </div>
      </div>
    `;
...
function renderBlocklistTable(filtered, showsMap, container) {
  if (!container) return;
  ...
  container.innerHTML = filtered.map(item => {
    ...
    return `
      <tr class="${isSelected ? 'selected-row' : ''}">
        <td style="text-align:center;">
          <input type="checkbox" class="blocklist-table-cb" data-id="${item.id}" ${isSelected ? 'checked' : ''} onchange="toggleBlocklistItemSelection(${item.id})">
        </td>
        <td>
        ...
        <td>
          <div class="blocklist-reason-box ${reasonInfo.cls}" style="padding:4px 8px; font-size:11.5px; border-radius:6px;" title="${escapeHtml(item.reason || '')}">
            <div class="blocklist-reason-box-left" style="gap:4px;">
              <i data-lucide="${reasonInfo.icon}" class="ico-xs"></i>
              <span class="blocklist-reason-text">${escapeHtml(item.reason || reasonInfo.label)}</span>
            </div>
          </div>
...
async function removeBlocklistItem(id) {
  try {
    await api(`/api/v1/blocklist/${id}`, { method: "DELETE" });
    showToast(CURRENT_LANG === "en" ? "Release unblocked and removed from blocklist" : "Раздача разблокирована и удалена из черного списка", "success");
...
async function confirmClearCurrentShowBlocklist() {
  ...
  try {
    ...
    showToast(res?.message || (CURRENT_LANG === "en" ? "Blocklist cleared for title" : "Черный список тайтла очищен"), "success");
...
async function confirmClearAllBlocklist() {
  ...
  try {
    ...
    showToast(res?.message || (CURRENT_LANG === "en" ? "All blocklist items removed" : "Все записи черного списка удалены"), "success");
