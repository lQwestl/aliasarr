    ...
    def test_manual_import_hardlink_and_move_execution(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            mock_settings = SimpleNamespace(
                ...
                season_folder_template_anime="Season {season:02d}",
                season_folder_template_series="Season {season:02d}",
                rename_template_anime="{Series Title} - S{season:02d}E{episode:02d} - {Episode Title}",
                rename_template_series="{Series Title} - S{season:02d}E{episode:02d} - {Episode Title}",
                rename_template_movie="{Movie Title} ({Release Year}) {Quality Full}",
