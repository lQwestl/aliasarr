...
DESCRIPTION_RU = """
Добро пожаловать в официальную документацию REST API системы **Aliasarr** (версия 3.3.0).
...
DESCRIPTION_EN = """
Welcome to the official REST API documentation for **Aliasarr** (version 3.3.0).
