...
DESCRIPTION_RU = """
Добро пожаловать в официальную документацию REST API системы **Aliasarr** (версия 3.4.2).
...
DESCRIPTION_EN = """
Welcome to the official REST API documentation for **Aliasarr** (version 3.4.2).
