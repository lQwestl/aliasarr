...
NON_VIDEO_KEYWORDS = re.compile(
    ...
    r"\b(?:repack|русификатор|gamesvoice|ps\s*vr|steam|gog|duplex|codex|tenoke|razor1911|dlc|eshop|portable|suxxors|strike|playasia|insaneramzes|pSyPSP|unlimited)\b|"
