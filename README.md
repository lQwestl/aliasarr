...
[![Release: v2.4.0](https://img.shields.io/badge/Release-v2.4.0-blue.svg)](https://github.com/lQwestl/aliasarr/releases/tag/v2.4.0)
...
1. [Ключевые возможности](#ключевые-возможности)
   ...
   - [Жесткие ссылки (Hardlinks) и выборочное сидирование трекеров](#4-жесткие-ссылки-hardlinks-и-выборочное-сидирование-трекеров)
   ...
   - [Интерактивный интерфейс, Релиз логи и Dataset Harvester](#9-интерактивный-интерфейс-релиз-логи-и-dataset-harvester)
   - [Дополнительная документация и гайды](#10-дополнительная-документация-и-гайды)
...
- **Интеллектуальный парсер сезонов и эпизодов (100% точность по тестам)**:
  ...
  - Поддержка сплит-куров и составных частей (`Part 2`, `Cour 2`, `Часть 2`) с автоматическим смещением нумерации серий (1..12 ➔ 13..24).
...
### 4. Жесткие ссылки (Hardlinks) и выборочное сидирование трекеров
...
### 9. Интерактивный интерфейс, Релиз логи и Dataset Harvester
...
### 10. Дополнительная документация и гайды
