...
1. [Ключевые возможности](#ключевые-возможности)
   ...
   - [Кастомные форматы и профили качества](#6-кастомные-форматы-и-профили-качества)
...
- **Интеллектуальная фильтрация**:
  - Автоматический отсев не-видео релизов (манга, саундтреки OST, артбуки, аудиокниги, сэмплы).
...
- **Поддержка Companion-файлов**: автоматический перенос внешних субтитров (`.ass`, `.srt`), отдельных аудиодорожек (`.mka`), шрифтов (`fonts/`) и описаний (`.nfo`).
...
### 6. Кастомные форматы и профили качества
- **Гибкая система условий (Regex & Custom Formats)**: ранжирование по характеристикам (HDR10+, Dolby Vision, AV1, HEVC, x264, TrueHD Atmos, DTS-HD MA, FLAC, релиз-группы).
- **Пороги отсечки качества (Quality / Score Cutoff)** с автоматическим обновлением релизов при появлении более качественной раздачи.
...
### 9. Интерактивный интерфейс и фоновые операции
